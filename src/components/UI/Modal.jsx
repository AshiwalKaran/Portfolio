...
const Modal = ({ activeId, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div className="w-11/12 md:max-w-[400px] md:w-full absolute top-1/2  left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5 ">
        <div>
          <figure>
            <img
        ...
        <div>
          ...
          <a href={portfolio.siteUrl}>
            <button className="bg-primaryColor text-white py-2 px-4 my-8 mx-4 rounded-[8px] font-[500] hover:bg-headingColor ease-in duration-300">
              Live
            </button>
          </a>
